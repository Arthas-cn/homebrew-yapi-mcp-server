...
class YapiMcpServer < Formula
  ...
  homepage "https://github.com/Arthas-cn/YapiSwiftMCPServer"
  url "https://github.com/Arthas-cn/YapiSwiftMCPServer/releases/download/v1.0.0/YapiMCPServer-macos.tar.gz"
